...
var Table = {
    ...
    view: function (ctrl, args) {
		...
		ctrl.originaldata = ctrl.originaldata ? ctrl.originaldata : args.data;
        return this.showTable(ctrl, data);
    },
	showTable: function (ctrl, data) {
        var table = this,
            attr,
            header;
        //ctrl.data = data;
                ...
                return m("tbody", [
                    m('tr', [
                        m('td', {
                            ...
                            'class': ctrl.classes ? (ctrl.classes.columnLoading || 'center aligned') : 'center aligned'
                        }, [
                            m('div', {
                                'class': ctrl.classes ? (ctrl.classes.loader || 'ui active loader inline') : 'ui active loader inline'
                            }, '')
                        ])
                    ])
                ]);
    ...
    buildHeaders : function (ctrl, columns) {
        var sortedAscending = ctrl.classes ? (ctrl.classes.sortingAscending || 'sorted ascending') : 'sorted ascending',
            sortedDescending = ctrl.classes ? (ctrl.classes.sortedDescending || 'sorted descending') : 'sorted descending',
            notSorted = ctrl.classes ? (ctrl.classes.notSorted || '') : '',
            disabled = ctrl.classes ? (ctrl.classes.notSorted || 'disabled') : 'disabled';
        return columns.map(function (obj) {
            ...
            if (Object.prototype.toString.call(obj) === Object.prototype.toString.call('')) {
                ...
                return m('th', {
                    'class': ctrl.sorting[field] ? (ctrl.sorting[field]() ? (' ' + sortedAscending) : (' ' + sortedDescending)) : (' ' + notSorted),
                ...
                return m('th', {
                    'class': (ctrl.sorting[field] ? (ctrl.sorting[field]() ? (' ' + sortedAscending) : (' ' + sortedDescending)) : (' ' + notSorted)) +
                        ((obj.sorctrl === undefined || obj.sorctrl === true) ? '' : (' ' + disabled)) + ' ' + (obj.classes || ''),
                    onclick: (obj.sorctrl === undefined || obj.sorctrl === true) ? sortData.bind(this, ctrl, obj.sort || defaultSort, field, ctrl.data, ctrl.columnsGet[field]) : ''
                }, obj.label || field);
            }
        });
    },
